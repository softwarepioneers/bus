...
$paystack = "sk_test_9938a7714eb912e3f702c90d5fbca4041fa1c974"; //Do not change this! Redirect URL http://localhost/train/pro/verify.php
...
{ //error_reporting(E_ALL);
    ...
    try {
        ...
        $mail->Password = "0000001SMBTZ"; // SMTP password
...
<h1 style="text-align:center"><img src="images/trainlg.png" width="100" height="100"/><br/>SALAAMA TICKET RESERVATION SYSTEM<br/> BUS TICKET</h1> <div style="text-align:right; font-family:courier;font-weight:bold"><font size="+6">Ticket N<u>o</u>: $uniqueCode </font></div>
...
function printReport($id)
{
    ...
    $pdf->setTextShadow(array('enabled' => true, 'depth_w' => 0.2, 'depth_h' => 0.2, 'color' => array(196, 196, 196), 'opacity' => 1, 'blend_mode' => 'Normal'));
    // Set some content to print
    $html = '<h5 style="text-align:center"><img src="images/trainlg.png" width="80" height="80"/><br/>SALAAMA MODERN TICKET BU<br/> LIST OF BOOKINGS  FOR ' . $date . ' (' . $time . ')</h5> <div style="text-align:right; font-family:courier;font-weight:bold"><font size="+1">Train ' . $train . ' (' . $sn . ' Passengers) : ' . $schedule . ' </font></div>' . $result;
    // die($html);
    // Print text using writeHTMLCell()
    $pdf->writeHTMLCell(0, 0, '', '', $html, 0, 1, 0, true, '', true);
    // ---------------------------------------------------------
