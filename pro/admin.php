...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-success elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                    <!-- <i class="fa fa-bus img-circle elevation-2" aria-hidden="true"></i> -->
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=Terminal" class="nav-link 
                            <?php
                            echo (@$_GET['page'] == 'Terminal') ? 'active' : '';
                            ?>
                            ">
                                <i class="nav-icon fas fa-calendar-day"></i>
                                <p>
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=PaidBooking" class="nav-link 
                            <?php
                            echo (@$_GET['page'] == 'PaidBooking') ? 'active' : '';
                            ?>
                            ">
                                <i class="nav-icon fas fa-calendar-day"></i>
                                <p>
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=BookOffline" class="nav-link 
                            <?php
                            echo (@$_GET['page'] == 'BookOffline') ? 'active' : '';
                            ?>
                            ">
                                <i class="nav-icon fas fa-calendar-day"></i>
                                <p>
        ...
        <div class="content-wrapper">
            ...
            elseif ($_GET['page'] == 'Terminal')
                include 'admin/Terminal.php';

                elseif ($_GET['page'] == 'PaidBooking')
                include 'admin/PaidBooking.php';

                elseif ($_GET['page'] == 'BookOffline')
                include 'admin/BookOffline.php';
