                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-800">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Total Bookings</th>

                                <th scope="col" class="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Date/Time</th>
            ...
            $id = $fetch['id']; ?>
                        <tr>
                                ...
                                <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                    ...
                                    <?php echo getTrainName($fetch['train_id']); ?>
                                    </div>
                                </td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div>
                                        <h4 class="text-gray-700 dark:text-gray-200"><?php echo getRoutePath($fetch['route_id']);
                    $fullname = " Schedule" ?></h4>
                                          </div>
                                </td>
                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <div class="flex items-center">
                                         <p class="flex items-center justify-center w-8 h-8 -mx-1 text-xs text-blue-600 bg-blue-100 border-2 border-white rounded-full">+<?php $array = getTotalBookByType($id);
                    echo (($array['first'] - $array['first_booked'])), " " . "<hr/>";
                    ?></p>
                                    </div>
                                </td>

                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                    <p><?php echo $fetch['date'], " / ", formatTime($fetch['time']); ?></p>
